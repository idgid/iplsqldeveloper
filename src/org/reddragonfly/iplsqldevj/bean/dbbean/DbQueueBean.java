...
public class DbQueueBean extends DbBean {
	
	public static String TYPE = "queue";
	...
	public DbQueueBean(String name){
		this.name = name;
	}
	...
	public String getMenuScript(){
		...
		returnVal.append("myMenu.add(new WebFXMenuSeparator());");
		returnVal.append("myMenu.add(new WFXMI(\"Enqueue enabled\", \"\"));");
		returnVal.append("myMenu.add(new WFXMI(\"Dequeue enabled\", \"\"));");
		returnVal.append("myMenu.add(new WebFXMenuSeparator());");
