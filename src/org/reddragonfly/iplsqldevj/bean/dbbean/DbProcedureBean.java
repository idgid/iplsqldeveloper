...
public class DbProcedureBean extends DbBean {

	public static String TYPE = "procedure";
	public static String ICON_INVALID = "dbimages/invalid_prcs.png";
	public static String ICON_VALID = "dbimages/valid_prcs.png";
	...
	public DbProcedureBean(String name){
		this.name = name;
	}
	...
	public String getMenuScript(){
		...
		returnVal.append("myMenu.add(new WFXMI(\"Edit\",\"javascript:showEditObject('"+TYPE+"','"+name+"','Procedures','Edit');\"));");
	...
	public String getParameter(String name) {
		...
		try{
			...
			while(rs.next()){
				i = 1;
				if (CharSet.nullToEmpty(rs.getString(1)).equals("")) sb.append("<tree text=\"(RESULT)\" icon=\""+ ICON_PARAMTER +"\" />");
				else sb.append("<tree text=\""+CharSet.nullToEmpty(rs.getString(1))+"\" icon=\""+ ICON_PARAMTER +"\" />");
			}
